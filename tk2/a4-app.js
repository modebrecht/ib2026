(function(){
  ...
  var META={
    A:{q:8,name:'Programme & Browser',theme:{accent:'#06b6d4',rgb:'6,182,212'},lesson:[
  ...
  var fresh={A:false,B:false},theoryScenes={A:[],B:[]},theoryRendered={A:false,B:false},secondPassActive=false;
