(function(){
  ...
  function createWindowResizeScene(container,type,options){
    ...
    container.innerHTML=''
      ...
      +'<g class="key-row" transform="translate(449 225)">'+window.tk2SceneKeycaps.markup(['Win',isMax?'↑':'↓'],'utility')+'</g>'
  ...
  function createA4Scene(container,options){
    ...
    var main=cfg.family==='browser'?browserMarkup():(cfg.family==='doc'?docMarkup():windowsMarkup()),keyX=Math.max(410,660-window.tk2SceneKeycaps.rowWidth(cfg.keys,keyProfile));
    container.innerHTML='<svg class="tk2-a4-scene" viewBox="0 0 680 320" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Animation: '+esc(cfg.label)+'"><defs><filter id="'+uid+'Shadow" x="-30%" y="-30%" width="170%" height="180%"><feDropShadow dx="0" dy="8" stdDeviation="9" flood-color="#020617" flood-opacity=".38"/></filter></defs><rect width="680" height="320" rx="24" fill="#07101f"/><circle cx="620" cy="42" r="100" fill="#06b6d4" opacity=".045"/>'+main+'<g class="keys" transform="translate('+keyX+' 244)">'+window.tk2SceneKeycaps.markup(cfg.keys,keyProfile)+'</g><g class="toast" transform="translate(514 20)" opacity="0"><rect width="145" height="30" rx="15" fill="#052e2b" stroke="#10b981"/><text class="toast-text" x="72.5" y="19" text-anchor="middle" font-family="Arial" font-size="10" font-weight="800" fill="#a7f3d0">Fertig</text></g></svg>';
